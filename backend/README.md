...
## Project Structure
    ...
    ├── testapiautoconnect_125341  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_125341`
...
2. Clone this repo and `cd testapiautoconnect_125341`
